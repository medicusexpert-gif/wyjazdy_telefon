...
function renderTable(rows) {
    ...
    let html = `<table><colgroup><col style="width:105px;"><col style="width:65px;"><col style="width:300px;"><col style="width:300px;"><col style="width:300px;"><col style="width:300px;"></colgroup>`;
